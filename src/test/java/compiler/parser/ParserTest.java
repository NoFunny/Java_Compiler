...
public class ParserTest extends TestCase {
    ...
    public void testGo() {
        String input = readFile("https://github.com/NoFunny/Java_Compiler/raw/master/src/main/resources/syntaxTest.java");
        Tokenizer lexer = new Tokenizer(input);
        Parser parser = new Parser(new LexerList(lexer));
        Assert.assertEquals(null,parser.go());

        String input1 = readFile("https://github.com/NoFunny/Java_Compiler/raw/master/src/main/resources/grammarTest.java");
        Tokenizer lexer1 = new Tokenizer(input1);
        Parser parser1 = new Parser(new LexerList(lexer1));
        Assert.assertEquals(null, parser1.go());

        String input2 = readFile("https://github.com/NoFunny/Java_Compiler/raw/master/src/main/resources/funcTest.java");
